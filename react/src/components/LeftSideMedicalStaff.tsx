    ...
    return (
        <div className="h-screen flex">
            <div className="w-64 bg-blue-900 text-white flex flex-col p-6 space-y-4">
                ...
                <div onClick={() => navigate('/')} className="hover:bg-blue-700 rounded-lg px-4 py-2 cursor-pointer">Thông tin cá nhân</div>
                <div onClick={() => navigate('/')} className="hover:bg-blue-700 rounded-lg px-4 py-2 cursor-pointer">Sự cố y tế</div>
