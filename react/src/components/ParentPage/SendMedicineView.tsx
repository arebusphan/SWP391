          ...
          <div className="flex flex-row items-start gap-8">
            <div className="flex flex-col gap-4 w-[420px]">
              ...
              <DialogDescription className="text-gray-600">
                Provide medicine request details
              </DialogDescription>
              <SendMedicineForm
                onSuccess={() => {
          ...
          <tbody className="bg-white">
            {pagedRequests.length === 0 ? (
              ...
              pagedRequests.map((req) => {
                const canViewHistory = ["Approved", "Injected", "Administered"].includes(
                  req.status
                );
                return (
                  <tr
                  ...
                  >
                    ...
                    <td className="p-4 align-top">
                      <span
                        className={`px-3 py-1 rounded-full text-white text-sm font-semibold drop-shadow ${
                          req.status === "Pending"
                            ? "bg-yellow-500"
                            : req.status === "Approved"
                            ? "bg-green-500"
                            : req.status === "Injected" || req.status === "Administered"
                            ? "bg-blue-900"
                            : "bg-red-500"
                        }`}
                      >
