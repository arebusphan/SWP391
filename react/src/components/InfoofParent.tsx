      ...
      <div className="p-6 max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-6 border border-gray-200 rounded-2xl p-6 bg-white shadow-md">
              ...
              <div className="w-full lg:w-1/2">
                  <h2 className="text-xl font-bold text-blue-700 mb-4">👨‍👩‍👧 Parent Information</h2>
              ...
              {/* Connected Students */}
              <div className="w-full lg:w-1/2">
                  <h2 className="text-xl font-bold text-green-700 mb-4">🎓 Connected Students</h2>
          ...
          <Dialog open={openDialog} onOpenChange={setOpenDialog}>
              <DialogContent className="!w-full !max-w-[800px]">
                      ...
                      <DialogTitle className="text-blue-700 text-xl font-semibold">Student Health Info</DialogTitle>
