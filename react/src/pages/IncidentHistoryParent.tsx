...
const formatDate = (dateStr: string) => {
    ...
    return isNaN(date.getTime()) ? "Unknown date" : date.toLocaleString("en-GB");
};
...
const IncidentHistoryParent = () => {
    ...
    return (
        <div>
            ...
            <div className="rounded-2xl mx-auto drop-shadow">
                {incidents.length === 0 ? (
                            ...
                            <table className="w-full text-sm text-center">
                                <thead className="bg-blue-900 text-white">
                                    <tr>
                                        ...
                                        <th className="border px-3 py-2">Incident</th>
